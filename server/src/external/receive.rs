...
use crate::{AppState, ReceivedMessage, ReceiveMessageResponse};
use std::net::IpAddr;

pub fn external_receive_message(router: routing::Router, app_state: AppState, ip: IpAddr) -> routing::Router {
