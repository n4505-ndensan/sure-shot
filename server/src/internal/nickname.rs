...
pub fn internal_get_nickname(router: routing::Router, app_state: AppState) -> routing::Router {
...
pub fn internal_update_nickname(router: routing::Router, app_state: AppState) -> routing::Router {
